...
class Pagination(object):
    def __init__(self, current_page, all_count, base_url, params, per_page_num=8, pager_count=10, ):
        """
        封装分页相关数据
...
#             self.params[
#                 "page"] = i  # # {"page":"7","title_startwith":"py","id__gt":"5"}  #  "page=7&title_startwith=py&id__gt=5"
#             if i == self.current_page:
